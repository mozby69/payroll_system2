...
export async function creataBonusRuleController(req, res) {
    try {
...
export async function updateBonusRuleController(req, res) {
    try {
...
export async function getAllBonusRulesController(req, res) {
    try {
...
export async function deleteBonusRuleController(req, res) {
    try {
        const id = Number(req.params.id);
        if (Number.isNaN(id)) {
...
// Company Rules 
export async function createBonusRuleCompanyController(req, res) {
    try {
...
export async function getBonusRuleCompanyController(req, res) {
    try {
...
export async function deleteBonusCompanyRuleController(req, res) {
    try {
        const id = Number(req.params.id);
        if (Number.isNaN(id)) {
            return res.status(400).json({
...
export async function generateBonusController(req, res) {
    try {
...
export async function getEmployeeBonusController(req, res) {
    try {
...
export async function getEmployeeBonusBySummaryIdController(req, res) {
    try {
...
// bonus.controller.ts
export async function resetBonusController(req, res) {
    try {
...
export async function submitBonusController(req, res) {
    try {
...
export async function getBonusSummaryController(req, res) {
    try {
...
export async function approveBonusController(req, res) {
    try {
        ...
        // Call service
        const result = await approveBonusService(bonusSummaryId, approvedBy);
        // Success response
        return res.status(200).json(result);
    }
    catch (error) {
...
export async function rejectBonusController(req, res) {
    try {
        const bonusSummaryId = Number(req.params.id);
        if (isNaN(bonusSummaryId)) {
            return res.status(400), json({
        ...
        const result = await rejectBonusService(bonusSummaryId, releasedBy);
        return res.status(200).json(result);
    }
    catch (error) {
        return res.status(400).json({
...
export async function releaseBonusController(req, res) {
    try {
        // Validate ID
        const bonusSummaryId = Number(req.params.id);
        if (isNaN(bonusSummaryId)) {
        ...
        const releasedBy = req.user.id;
        // Call service
        const result = await releaseBonusService(bonusSummaryId, releasedBy);
        //  Success response
        return res.status(200).json(result);
    }
    catch (error) {
...
export async function getEmployeesByBonusSummaryController(req, res) {
    try {
        const companyCode = req.query.companyCode;
        const id = req.query.id
            ? Number(req.query.id)
            : undefined;
        const data = await getEmployeesByBonusSummarySerive(companyCode, id);
        return res.status(200).json({
            success: true,
            data,
        });
...
export async function updateBonusController(req, res) {
    try {
        ...
        const result = await updateBonusService(validated.id, validated.bonusAmount, req.user.id);
        return res.status(200).json({
            success: true,
...
export async function checkPayroll(req, res) {
