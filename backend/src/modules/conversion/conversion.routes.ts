...
import { conversionReportController, DisplayConversionArchiveController, getAttendanceCountController, getConversionArchiveController, getConversionArchiveForBankController, saveConversionArchiveController, updateVacationLeaveController } from "./conversion.controller";
...
router.get("/conversion-bank/:id",getConversionArchiveForBankController);
