...
export const getAllEmployees = async ({ skip, take, search, department, company, status, }) => {
...
export const countEmployees = async (filters) => {
...
export const updateEmployeePayroll = async (empCode, payLoad, changedBy) => {
    try {
...
export const getEmployeesByCompanyGrouped = async (companyCode) => {
...
export const bulkIncreaseSalary = async (empCodes, amount, reason, changedBy) => {
