...
import { addEmployeeLoanController, getAllLoans, getLoanLedgerById, getEmpLoanById, updateEmployeeLoanController, closedEmployeeLoanController, payEmployeeLoanController, getLoansByEmpCodeController, getBonusRules, searchEmployeeController } from "./loan.controller";
const router = Router();
