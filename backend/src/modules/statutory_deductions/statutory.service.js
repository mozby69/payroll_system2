...
//SSS
export async function displaySSSContributions({ page, limit, search }) {
    try {
...
export async function updateSSSContribution(id, data) {
...
// PAGIBIG 
export async function displayPagibigContributions({ page, limit, search }) {
    try {
...
export async function updatePagibigContribution(id, data) {
...
export async function updatePhilhealth(id, SettingPercentage) {
...
export async function updateWTax(id, data) {
