      ...
      >
        <div className="w-[95%] lg:w-[90%] flex flex-col-reverse gap-y-12 lg:flex-row z-50 px-12">
          <div className="flex flex-col gap-8 w-full lg:w-[55%]">
            <h1 className="font-bold text-lg">JAMERO GROUP OF COMPANIES</h1>

            <div className="flex flex-col gap-12">
              <h1 className="text-heading font-bold text-5xl max-w-2xl">
                <span className="text-mainhighlight">Payroll</span> Processing{" "}
                <br />& Reporting{" "}
                <span className="text-mainhighlight">System</span>
              </h1>
          ...
          <div className="w-full lg:w-[45%] flex items-center justify-center">
            <div
              className="bg-mainNeutral h-auto w-full rounded-sm shadow-[-20px_-13px_5px_4px_rgba(23,37,100,1)]
