...
import ConfigureWtax from "@/app/ModalContent/Statutory/ConfigureWtax";
        ...
        <div className="p-2">
            ...
            <div className="py-4 flex justify-between">
                ...
                {/* <div>
                    <button
                     onClick={openModal2}
                     className="bg-green-700 hover:bg-green-600 py-2.5 px-4 rounded shadow text-white">Configure</button>
                </div> */}
            ...
            {isModal2 && (
                <RequestModal size="sm" title={`Configure Wtax Contributions`} onClose={closeModal2}>
                    <ConfigureWtax />
                </RequestModal>
            )}
